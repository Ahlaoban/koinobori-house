...
**Homepage = 10 mouvements** (v2.0 §4 en comptait 11 ; consolidation du 2026-09-16) : Header Fusuma · Hero · Les cinq mondes · Créations BCDG · L'Atelier · Lifestyle & Koi (absorbe l'ancien mouvement « Arts de vivre ») · Le Manifeste · Professionnels · Newsletter · Footer ligne d'horizon. ⚠️ **La composition et le texte du mouvement consolidé « Lifestyle & Koi » restent à valider par Alain** : proposition codée dans `kh-home.php` (titre, chapô, lien vers Lifestyle, puis les 3 derniers articles s'il y en a) ; la redirection 301 des anciennes pages est prête dans `wp/mu-plugins/koino-arts-de-vivre-redirect.php`, à déposer après audit et transfert du contenu.
