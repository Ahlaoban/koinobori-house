...
**Cap Alain du 21 septembre 2026 (soir) — base technique propre d'abord.** Le menu a 5 rubriques ; « Arts de vivre » est supprimé car redondant avec Lifestyle (redirection 301 déposée sur le staging) ; on décidera plus tard si le libellé **français** « Lifestyle » devient « Arts de vivre », le mot « Lifestyle » étant conservé en anglais. **Tout texte public doit être modifiable dans l'admin WordPress** : Alain retravaille tous les textes et **Catherine, directrice de la communication, les relit tous**. Conséquence : plus aucun texte public en dur dans le thème, ce qui **révise l'arbitrage du matin sur la home PHP**. ✅ **Home éditable depuis le 2026-09-21** (thème enfant 1.3.0, déployé sur le staging) : ses textes sont le contenu en blocs natifs des pages 318 (FR) et 319 (EN), `kh-home.php` n'est plus qu'un cadre ; mode d'emploi et règles d'édition : [docs/development/home-editable.md](docs/development/home-editable.md). Restent en dur : les libellés du header et du footer (17), à rendre éditables par de vrais menus FR/EN créés dans l'admin. Photos et vidéos arrivent progressivement : le site ouvre sans les attendre. Fonds, images et ambiances de chaque catégorie et de chaque rubrique suivent la charte et les images de Manus. Des **catalogues complémentaires** (foulards, T-shirts, noren…) sont prévus : structure et calendrier à cadrer avec Alain avant de toucher à la taxonomie figée à 5 collections.
...
**Homepage = 10 mouvements** (v2.0 §4 en comptait 11 ; consolidation du 2026-09-16) : Header Fusuma · Hero · Les cinq mondes · Créations BCDG · L'Atelier · Lifestyle & Koi (absorbe l'ancien mouvement « Arts de vivre ») · Le Manifeste · Professionnels · Newsletter · Footer ligne d'horizon. ⚠️ **La composition et le texte du mouvement consolidé « Lifestyle & Koi » restent à valider par Alain** : proposition codée dans `kh-home.php` (titre, chapô, lien vers Lifestyle, puis les 3 derniers articles s'il y en a) ; composition et texte validés par Alain le 2026-09-21 ; la redirection 301 des anciennes pages (`wp/mu-plugins/koino-arts-de-vivre-redirect.php`) est déposée sur le staging depuis le 2026-09-21.
