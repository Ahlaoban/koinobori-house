...
La présente politique explique comment Koinobori House collecte et traite les données personnelles des visiteurs, clients, prospects, abonnés à la newsletter et personnes utilisant les formulaires du site.
...
Aucun délégué à la protection des données n'est désigné à ce stade, sauf décision contraire ultérieure.
...
- coordonnées : adresse email, adresse postale, téléphone si fourni ;
- données de commande : produits commandés, quantité, montant, date, numéro de commande ;
- données de livraison : adresse, pays, transporteur, suivi ;
- données de facturation : adresse de facturation, informations nécessaires aux factures ;
...
L’inscription à la newsletter repose sur le consentement. Le client peut se désinscrire à tout moment via le lien présent dans chaque email ou en contactant Koinobori House.

Koinobori House peut adresser à ses clients des informations ou offres concernant des produits analogues à ceux déjà commandés, sous réserve que le client ait été informé et puisse s’y opposer simplement et gratuitement.
...
Toute personne concernée peut demander l’accès, la rectification, l’effacement, la limitation, l’opposition au traitement ou la portabilité de ses données lorsque ces droits sont applicables.

Pour exercer ces droits : contact@koinoborihouse.com.

Une preuve d’identité peut être demandée en cas de doute raisonnable sur l’identité du demandeur.
...
Le site ne vise pas spécifiquement les mineurs. Les commandes doivent être passées par une personne ayant la capacité juridique de contracter.

## 11. Modification de la politique

La présente politique peut être modifiée pour tenir compte des évolutions du site, des prestataires ou de la réglementation.
